TOTAL_UPDATES=40    # Total number of training steps
WARMUP_UPDATES=4    # Warmup the learning rate over this many updates
...
python train.py --fp16 $DATA_DIR \
    --task distill_masked_lm --criterion distill_masked_lm \
    ...
    --student-restore-file /data/student_model.pt \
