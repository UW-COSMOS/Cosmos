...
class CopyTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--mask-prob', default=0.33, type=float,
    ...
    def load_dataset(self, split, epoch=0, combine=False):
        ...
        dataset = TokenBlockDataset(
            dataset,
            dataset.sizes,
            self.args.tokens_per_sample - 1 - 100 ,  # one less for <s>, 70 less because of our new copying
        ...
        src_dataset, tgt_dataset = CopyTokensDataset.apply_mask(
            dataset,
            self.source_dictionary,
