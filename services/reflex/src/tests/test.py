...
def main():
    test_json = [{"uuid": "81756", "obj_label": "Winnipeg Jets", "sub_label": "Nicolas Petan", "evidences": [{"masked_sentence": "Nicolas Petan (born March 22, 1995) is a Canadian ice hockey player, who is currently playing for the Manitoba Moose in the American Hockey League after being reassigned from the Winnipeg Jets in the National Hockey League."}]}, 
